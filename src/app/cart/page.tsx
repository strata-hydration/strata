        ...
        {viewMode === 'explore' ? (
          ...
          >
            ...
            <motion.button
              ...
              whileHover={{ y: -8, scale: 1.01 }}
              className="group relative isolate overflow-hidden rounded-[1.75rem] border border-yellow-200/80 bg-white/60 p-9 text-left sm:p-10 lg:p-11 backdrop-blur-xl shadow-[0_16px_44px_rgba(202,138,4,0.18)] min-h-[22rem] sm:min-h-[24rem]"
            >
              <div className="absolute inset-0 bg-[linear-gradient(145deg,rgba(255,251,235,0.9),rgba(254,243,199,0.85))]" />
              <motion.div
                aria-hidden
                className="pointer-events-none absolute -left-20 top-0 hidden h-full w-20 rotate-[18deg] transform-gpu bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.55),transparent)] sm:block"
                animate={{ x: ['-10%', '520%'] }}
              ...
              <div className="relative z-10 flex h-full flex-col">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-700">Express quick-commerce delivery</p>
